...
export const profileModel = {
  ...
  async updateUserProfile(userId, { full_name, phone, dob, gender, address, occupation, email }) {
    ...
    try {
      ...
      if (existing.length > 0) {
        ...
        await conn.query(
          ...
          [dob || null, (gender || null), (address || null), (occupation || null), userId]
        ...
        await conn.query(
          ...
          [profileId, userId, (dob || null), (gender || null), (address || null), (occupation || null)]
